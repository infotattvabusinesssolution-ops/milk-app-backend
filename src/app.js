...
import authRoutes from './routes/auth.routes.js';import customerRoutes from './routes/customer.routes.js';import paymentRoutes from './routes/payment.routes.js';import partnerRoutes from './routes/partner.routes.js';import adminRoutes from './routes/admin.routes.js';import publicRoutes from './routes/public.routes.js';import farmerRoutes from './routes/farmer.routes.js';import {notFound,errorHandler} from './middleware/error.js';
