...
const schema=new mongoose.Schema({name:{type:String,default:'Customer'},phone:{type:String,unique:true,sparse:true,index:true},email:String,role:{type:String,enum:['customer','partner','admin'],default:'customer'},passwordHash:String,isEmailVerified:{type:Boolean,default:false},status:{type:String,enum:['active','pending','blocked'],default:'active'},addresses:[addressSchema],fcmTokens:[String],walletBalance:{type:Number,default:0}},{timestamps:true});
